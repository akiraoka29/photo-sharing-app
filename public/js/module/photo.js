...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"), __webpack_require__(/*! bootstrap */ "./node_modules/bootstrap/dist/js/bootstrap.esm.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($) {
  // Initialize
  var Props = {
    element: {
  ...
  Modal.event = {
    showSignupOnClick: function showSignupOnClick() {
      $(document).on('click', Props.element.signupLink, function (event) {
        ...
        if (!$button.prop('disabled')) {
          ...
          Props.element.signupModal.on('hidden.bs.modal', function () {
...
/***/ "./resources/js/module/photo.js":
/*!**************************************!*\
  !*** ./resources/js/module/photo.js ***!
  \**************************************/
/***/ ((module, exports, __webpack_require__) => {

var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"), __webpack_require__(/*! ./modal */ "./resources/js/module/modal.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($, modal) {
  // Initialize
  var Props = {
    element: {},
    "class": {
  ...
  Photo.active = {
    ...
    likePhoto: function likePhoto(isAuth) {
      if (isAuth == 0) {
  ...
  Photo.event = {
    photoOnClick: function photoOnClick() {
    ...
    likeOnClick: function likeOnClick() {
      $(Props["class"].photoContainer).on('click', Props["class"].likeButton, function (event) {
        var $button = $(event.currentTarget);
        if (!$button.prop('disabled')) {
          $button.prop('disabled', true);
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/module/photo.js");
/******/ 	
/******/ })()
;